...
HEALTHCARE_DEMO_ENTITIES: tuple[DemoArchiveEntity, ...] = (
    DemoArchiveEntity(
        ...
        entity_type="patient",
        metadata={"industry_pack": "healthcare", "demo_archive_key": "healthcare", "department": "Oncology", "condition": "Cancer", "responsible_person": "Dr Jones", "risk_rating": "High", "jurisdiction": "United Kingdom", "treatment_status": "Active"},
        files={
    ...
    DemoArchiveEntity(
        ...
        entity_type="patient",
        metadata={"industry_pack": "healthcare", "demo_archive_key": "healthcare", "department": "Oncology", "condition": "Cancer", "responsible_person": "Dr Jones", "risk_rating": "Medium", "jurisdiction": "United Kingdom", "treatment_status": "Pre-treatment"},
        files={
    ...
    DemoArchiveEntity(
        ...
        entity_type="patient",
        metadata={"industry_pack": "healthcare", "demo_archive_key": "healthcare", "department": "Cardiology", "condition": "Arrhythmia", "responsible_person": "Dr Smith", "risk_rating": "Low", "jurisdiction": "United Kingdom", "treatment_status": "Monitoring"},
        files={
...
SUPPLIER_DEMO_ENTITIES: tuple[DemoArchiveEntity, ...] = (
    DemoArchiveEntity(
        ...
        metadata={"industry_pack": "supplier_due_diligence", "demo_archive_key": "supplier_due_diligence", "supplier_category": "IT", "criticality": "Critical", "service_type": "Cloud hosting", "contract_owner": "Technology", "risk_rating": "High", "jurisdiction": "United Kingdom"},
        files={
    ...
    DemoArchiveEntity(
        ...
        entity_type="supplier",
        metadata={"industry_pack": "supplier_due_diligence", "demo_archive_key": "supplier_due_diligence", "supplier_category": "IT", "criticality": "Material", "service_type": "Software support", "contract_owner": "Operations", "risk_rating": "Medium", "jurisdiction": "Guernsey"},
        files={
    ...
    DemoArchiveEntity(
        ...
        entity_type="supplier",
        metadata={"industry_pack": "supplier_due_diligence", "demo_archive_key": "supplier_due_diligence", "supplier_category": "Legal", "criticality": "Standard", "service_type": "Legal services", "contract_owner": "Legal", "risk_rating": "Low", "jurisdiction": "Jersey"},
        files={
...
class DemoArchiveService:
    ...
    def generate(self, archive_key: str) -> dict[str, Any]:
        ...
        for entity in entities:
            ...
            container = EntityContainerBuilder(self.db).rebuild(result.entity_external_id)
            index = FitsContainerReader(self.db).rebuild_index_from_current_fits(result.entity_external_id)
            results.append(
                {
    ...
    def _entity_zip(self, entity: DemoArchiveEntity) -> bytes:
        ...
        with zipfile.ZipFile(buffer, "w", compression=zipfile.ZIP_DEFLATED) as archive:
            ...
            archive.writestr(f"{root}metadata/audit_events.json", json.dumps([{"event": "demo_archive_generated", "entity_id": entity.external_id, "industry_pack": metadata.get("industry_pack")}], indent=2))
